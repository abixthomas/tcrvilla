                ...
                <div className="flex flex-col lg:flex-row gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="absolute -bottom-8 -right-8 bg-white p-6 rounded-2xl shadow-xl border border-gray-100 hidden md:block">
                            <div className="text-center">
                                <span className="block text-4xl font-bold text-secondary font-serif">15+</span>
                    ...
                    <div className="lg:w-1/2">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                        >
                            <h4 className="text-secondary font-bold uppercase tracking-widest text-sm mb-2">Who We Are</h4>
                                    ...
                                    return (
                                        <div key={index} className="flex flex-col">
                                            <div className="flex items-center gap-2 mb-2">
                                                ...
                                                <span className="text-3xl font-bold text-primary font-serif">{stat.value}</span>
                                            </div>
