...
import { PropertySpecifications } from "@/components/property-detail/PropertySpecifications"
            ...
            <div className="container mx-auto px-4 md:px-6 py-12">
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
                    ...
                    <div className="w-full lg:w-[65%] space-y-12">
                        ...
                        {/* B. Video Link Section - Updated to Remove Black */}
                        <div className="bg-gradient-to-r from-primary to-primary/80 rounded-2xl p-6 md:p-8 flex flex-col md:flex-row items-center gap-6 relative overflow-hidden group cursor-pointer shadow-lg">
                            ...
                            <div className="absolute inset-0 bg-gradient-to-r from-primary via-primary/90 to-transparent mix-blend-multiply" />
                            ...
                            <div className="relative z-10 text-center md:text-left">
                                ...
                                <p className="text-white/80 text-sm">Take a cinematic tour of this residence.</p>
                            </div>

                            <button className="relative z-10 md:ml-auto px-6 py-3 bg-white text-primary text-xs font-bold uppercase tracking-widest rounded-lg hover:bg-gray-50 transition-colors">
                                Play Video
                            </button>
                        </div>
                        ...
                        <div id="about" className="border-t border-gray-100 pt-12">
                            ...
                            <h3 className="text-2xl font-display font-medium text-primary mb-8">About This Property</h3>
                            <PropertyNarrative property={property} />
                        </div>

                        {/* NEW: Specifications & Premium Highlights */}
